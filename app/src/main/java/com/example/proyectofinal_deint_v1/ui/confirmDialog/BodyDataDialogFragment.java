...
public class BodyDataDialogFragment extends DialogFragment {

    public static final String CONFIRM_DELETE = "deleteBody";
        ...
        if(getArguments() != null)
        {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    BodyData bodyData = (BodyData) getArguments().getSerializable("deletedBody");
                    ...
                    NavHostFragment.findNavController(BodyDataDialogFragment.this).navigate(R.id.homeFragment, bundle);
                }
            });
